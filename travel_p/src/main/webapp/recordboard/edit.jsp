		...
		<form method="POST" action="${pageContext.request.contextPath }/recordboard/edit.do?num=${vo.num}" enctype="multipart/form-data">
			<div class="form-group">
				<label for="writer">작성자</label> <input type="text"
					class="form-control" id="writer" value="${sessionScope.loginId }" name="writer" required readonly>
			</div>
			<div class="form-group">
				<label for="title">수정할 제목</label> <input type="text"
					class="form-control" id="title" name="title" value="${vo.title }" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="title">수정할 여행경비</label> <input type="text"
					class="form-control" id="title" name="price" value="${vo.price }" required>
			</div>
			<div class="form-group">
				<label for="photo1">바꾸고 싶은 사진 1</label> <input type="file"
					class="form-control-file" id="photo1" name="file1" required>
			</div>
			<div class="form-group">
				<label for="photo2">바꾸고 싶은 사진 2</label> <input type="file"
					class="form-control-file" id="photo2" name="file2">
			</div>
			<div class="form-group">
				<label for="photo2">바꾸고 싶은 사진 3</label> <input type="file"
					class="form-control-file" id="photo3" name="file3">
			</div>
			<button type="submit" class="btn btn-primary">수정하기</button>
			<a href="${pageContext.request.contextPath }/recordboard/list.do"><button type="button" class="btn btn-primary">수정취소</button></a>
		</form>
	</div>
</body>
</html>